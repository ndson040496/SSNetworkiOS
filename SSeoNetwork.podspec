...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/ndson040496/SSNetworkiOS"
  ...
  # ――― Source Location ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  spec.source       = { :git => "https://github.com/ndson040496/SSNetworkiOS.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "SSNetwork", "SSNetwork/**/*.{swift}"
